function sendEmail {
    ...
    $server = @{
        SmtpServer =  [environment]::GetEnvironmentVariable('EMAILSERVER', 'User')
        Port =  [environment]::GetEnvironmentVariable('EMAILPORT', 'User')
...
Export-ModuleMember -Function @('generateHtmlBody', 'sendEmail')
